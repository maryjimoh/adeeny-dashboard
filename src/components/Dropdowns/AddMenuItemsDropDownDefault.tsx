...
const AddMenuItemsDropdown = () => {
  ...
  return (
    <div className="relative flex">
      ...
      >
        <Link  to="/addwaqf" className="flex w-full items-center gap-2 rounded-sm px-4 py-1.5 text-left text-sm text-form-strokedark hover:text-primary  hover:bg-gray dark:hover:bg-meta-4">
          {/* <svg
            className="fill-current"
            width="16"
            height="16"
        ...
        <button className="flex w-full items-center gap-2 rounded-sm px-4 py-1.5 text-left text-form-strokedark hover:text-primary text-sm hover:bg-gray dark:hover:bg-meta-4">
          {/* <svg
            className="fill-current"
            width="16"
            height="16"
...
export default AddMenuItemsDropdown;
